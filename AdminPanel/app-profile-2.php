...
<!-- Mirrored from salero.dexignzone.com/xhtml/app-profile-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Mar 2024 05:37:46 GMT -->
<head>
    <meta charset="utf-8">
										...
										<div class="dropdown-menu dropdown-menu-end" style="">
											<div class="card border-0 mb-0">
												<div class="card-header py-2">
													<div class="products">
														<img src="images/user.jpg" class="avatar avatar-sm" alt="">
														<div>
                        ...
                        <div class="card card-profile">
							<div class="admin-user">
								<div class="img-wrraper">                              
									<div class="">
										<img src="images/user.jpg" class="rounded-circle"></div>
												...
												<div id="collapseOne2" class="accordion-collapse collapse show" aria-labelledby="headingOne2" data-bs-parent="#accordionExample2">
													<div class="accordion-body">
														<div class="products mb-3">
															<img src="images/contacts/pic2.jpg" class="avatar avatar-sm" alt="">
															<div>
														...
														<div class="products mb-3">
															<img src="images/contacts/pic3.jpg" class="avatar avatar-sm" alt="">
															<div>
														...
														<div class="products mb-3">
															<img src="images/contacts/pic1.jpg" class="avatar avatar-sm" alt="">
															<div>
														...
														<div class="products">
															<img src="images/contacts/d4.jpg" class="avatar avatar-sm" alt="">
															<div>
														...
														<div class="profile-interest">
															<div class="row mt-4 sp4" id="lightgallery">
																<a href="images/profile/2.jpg" data-exthumbimage="images/profile/2.jpg" data-src="images/profile/2.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
																	<img src="images/profile/2.jpg" alt="" class="px-1 py-1 img-fluid rounded">
																</a>
																<a href="images/profile/3.jpg" data-exthumbimage="images/profile/3.jpg" data-src="images/profile/3.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
																	<img src="images/profile/3.jpg" alt="" class="px-1 py-1 img-fluid rounded">
																</a>
																<a href="images/profile/4.jpg" data-exthumbimage="images/profile/4.jpg" data-src="images/profile/4.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
																	<img src="images/profile/4.jpg" alt="" class="px-1 py-1 img-fluid rounded">
																</a>
																<a href="images/profile/3.jpg" data-exthumbimage="images/profile/3.jpg" data-src="images/profile/3.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
																	<img src="images/profile/3.jpg" alt="" class="px-1 py-1 img-fluid rounded">
																</a>
												...
												<div id="collapseOne6" class="accordion-collapse collapse show" aria-labelledby="headingOne6" data-bs-parent="#accordionExample6">
													<div class="accordion-body">
														<div class="friend-list">
															<img src="images/profile/friends/f3.jpg" class="avatar avatar-sm" alt="">
															<img src="images/contacts/pic2.jpg" class="avatar avatar-sm" alt="">
															<img src="images/contacts/pic3.jpg" class="avatar avatar-sm" alt="">
															<img src="images/profile/friends/f2.jpg" class="avatar avatar-sm" alt="">
															<img src="images/contacts/pic1.jpg" class="avatar avatar-sm" alt="">
															<img src="images/contacts/d4.jpg" class="avatar avatar-sm" alt="">
															<img src="images/profile/friends/f4.jpg" class="avatar avatar-sm" alt="">
															<img src="images/profile/friends/f1.jpg" class="avatar avatar-sm" alt="">
															<img src="images/profile/friends/f3.jpg" class="avatar avatar-sm" alt="">
															<img src="images/contacts/pic2.jpg" class="avatar avatar-sm" alt="">
															<img src="images/contacts/pic3.jpg" class="avatar avatar-sm" alt="">
															<img src="images/profile/friends/f2.jpg" class="avatar avatar-sm" alt="">
						...
						<div class="row">
							<div class="col-xl-12">
								<div class="card">
									<div class="card-header border-0">
										<div class="products">
											<img src="images/user.jpg" class="avatar avatar-sm rounded-circle" alt="">
											<div>
							...
							<div class="col-xl-12">
								<div class="card">
									<div class="card-header border-0">
										<div class="products">
											<img src="images/profile/friends/f2.jpg" class="avatar avatar-sm rounded-circle" alt="">
											<div>
												<h5 class="mb-0"><a href="javascript:void(0)" class="text-black">Thomas Fleming</a></h5>
												<span>8 Hours ago</span>	
											</div>	
									...
									<div class="card-body pt-0">
										<div class="row">
											<div class="col-xl-6">
												<div class="post-img">
													<img src="images/post/post11.jpg" class="me-3">	
												</div>	
											</div>
											<div class="col-xl-6">
												<div class="post-img">
													<img src="images/post/post12.jpg" class="ms-3">	
												</div>	
											</div>
										</div>
										<div class="post-see d-flex align-items-center mt-3">
...
<!-- Mirrored from salero.dexignzone.com/xhtml/app-profile-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Mar 2024 05:37:49 GMT -->
</html>