...
<!-- Mirrored from salero.dexignzone.com/xhtml/chart-peity.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Mar 2024 05:38:08 GMT -->
<head>
    <meta charset="utf-8">
							...
							<div class="input-group search-area">
								...
								<span class="input-group-text"><a href="javascript:void(0)">
									<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<path opacity="0.3" d="M14.2929 16.7071C13.9024 16.3166 13.9024 15.6834 14.2929 15.2929C14.6834 14.9024 15.3166 14.9024 15.7071 15.2929L19.7071 19.2929C20.0976 19.6834 20.0976 20.3166 19.7071 20.7071C19.3166 21.0976 18.6834 21.0976 18.2929 20.7071L14.2929 16.7071Z" fill="#1921fa"/>
										<path d="M11 16C13.7614 16 16 13.7614 16 11C16 8.23859 13.7614 6.00002 11 6.00002C8.23858 6.00002 6 8.23859 6 11C6 13.7614 8.23858 16 11 16ZM11 18C7.13401 18 4 14.866 4 11C4 7.13402 7.13401 4.00002 11 4.00002C14.866 4.00002 18 7.13402 18 11C18 14.866 14.866 18 11 18Z" fill="#1921fa"/>
										</g>
										<defs>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class=" row">
                                            <div class="col-md-2 col-sm-4 col-6">
												<span class="data-attr" data-peity='{ "fill": ["rgb(25,33,250)", "rgba(25,33,250,1)"], "innerRadius": 10, "radius": 40 }'>1/7</span>
                                            </div>
                            ...
                            <div class="card-body pb-0">
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 pb-4">
                                        ...
                                        <div class="px-4"><span class="bar" data-peity='{ "fill": ["rgb(25,33,250)", "rgba(25,33,250,1)"]}'>6,2,8,4,3,8,1,3,6,5,9,2,8,1,4,8,9,8,2,1</span>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 pb-4">
                                        <h4 class="card-title mb-4">Bar Chart</h4>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-0">
                                        ...
                                        <div class=""><span class="donut" data-peity='{ "fill": ["rgb(25,33,250)", "rgba(185,168,255,1)"]}'>5/8</span>
                                        </div>
                                    </div>
                                    <div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-0">
...
<!-- Mirrored from salero.dexignzone.com/xhtml/chart-peity.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Mar 2024 05:38:11 GMT -->
</html>