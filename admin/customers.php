					...
					<ul class="revnue-tab nav nav-tabs" id="myTab" role="tablist">
						<li class="nav-item" role="presentation">
							<button class="nav-link active" id="status-tab" data-bs-toggle="tab"
								...
								aria-controls="active-tab-pane" aria-selected="true">Active</button>
						</li>
						<li class="nav-item" role="presentation">
							<button class="nav-link" id="inactive-tab" data-bs-toggle="tab"
								data-bs-target="#inactive-tab-pane" type="button" role="tab"
								aria-controls="inactive-tab-pane" aria-selected="false">Inactive</button>
						</li>
					</ul>
					<div>
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="tab-content" id="myTabContent">
											...
											<table id="empoloyees-tbl" class="table">
												...
												<tbody>
													<tr>
														...
														<td><span
																class="badge badge-rounded badge-outline-primary badge-lg">$
																924,23</span></td>
							...
							<div class="tab-pane fade show" id="inactive-tab-pane" role="tabpanel"
								aria-labelledby="inactive-tab" tabindex="0">
								<div class="card mt-2">
									<div class="card-body p-0">
										<div
											class="table-responsive active-projects style-1 ItemsCheckboxSec shorting ">
