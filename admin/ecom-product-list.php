                                    ...
                                    <div class="col-md-7 col-xxl-12">
                                        <div class="new-arrival-content position-relative">
                                            ...
                                            <p class="text-content">
                                                ...
                                                delights. Join us as we uncover the secrets behind mouth-watering dishes
                                                and share our passion for exceptional dining experiences.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row m-b-30">
                                    ...
                                    <div class="col-md-7 col-xxl-12">
                                        <div class="new-arrival-content position-relative">
                                            <h4><a href="ecom-product-detail.html">Por-Pier Pak (Vegetarian rolls</a>
                                            </h4>
                                            <div class="comment-review star-rating">
                                                <ul>
                                                    <li><i class="fa fa-star"></i></li>
