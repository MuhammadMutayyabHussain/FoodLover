				...
				<div class="row">
					...
					<div class="col-xl-6 custome-width">
						<div class="card">
							...
							<div class="card-body ">
								<p style="width:90%;">"Experience the epitome of culinary excellence with our restaurant
									website. Indulge in a seamless dining journey from menu exploration to reservation,
									...
									<div class="tab-pane fade show active" id="categories-tab-pane" role="tabpanel"
										...
										<div class="row">
											<div class="col-xl-8 col-md-7 col-sm-6">
												<div class="fav-box">
													<div class="fav-media"
														style="background-image: url(images/favirate-img/1.png);">
											...
											<div class="col-xl-4 col-md-5 col-sm-6">
												<div class="fav-box">
													<div class="fav-media"
														style="background-image: url(images/favirate-img/2.png);">
														<ul class="dz-badge-list">
															<li>
																<a href="javascript:void(0);"
																	class="badge badge-warning badge-sm"><svg width="13"
														...
														<ul class="dz-info-list">
															<li>
																<a href="ecom-product-detail.html"
																	...
																	Ice Cream</a>
																<p class="text-white mt-2">"Experience the epitome of
																	culinary excellence with our restaurant website.
																	Indulge in a seamless dining journey from menu
																	exploration to reservation, all at your fingertips."
																</p>
															</li>
															<ul
																class="d-flex align-items-center justify-content-between mb-3">
