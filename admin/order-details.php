										...
										<div class="history-box dz-scroll" style="height:300px;">
											<ul class="history">
												<li>
													...
													<a class="history-deatils" href="javscript:void(0);">
														<h6 class="font-w600">Your Order on Delivery by Courir</h6>
											...
											<ul class="history">
												<li>
													<div class="history-dot"></div>
													<a class="history-deatils" href="javscript:void(0);">
														<h6 class="font-w600">Driver Arrived at Restaurant</h6>
														<span class="text-primary">09:23 AM</span>
													</a>
												</li>
											...
											<ul class="history">
												<li>
													<div class="history-dot"></div>
													<a class="history-deatils" href="javscript:void(0);">
														<h6 class="font-w600">Preparing Your Order</h6>
														<span class="text-primary">09:23 AM</span>
													</a>
												</li>
											...
											<ul class="history">
												<li>
													<div class="history-dot"></div>
													<a class="history-deatils" href="javscript:void(0);">
														<h6 class="font-w600">Placed Order</h6>
														<span class="text-primary">09:23 AM</span>
													</a>
												</li>
									...
									<div class="card-body pt-2">
										<div class="food-items-bx">
											<div class="food-items-media">
												<img src="images/favirate-img/5.png" alt="">
											</div>
											<div class="d-flex align-items-end">
												<div class="food-items-info">
													<span class="text-primary">FOOD</span>
													<h6>Original Big Burger with Extra Spicy </h6>
													<span>x2</span>
												</div>
							...
							<div class="col-xl-12">
								<div class="card bg-primary h-auto">
									<div class="card-body text-center">
										<h3 class="mb-0 text-white">On Delivery</h3>
										<span class="text-white">Estimated Time 2 - 6 min</span>
									</div>
								</div>
							</div>
								...
								<div class="card h-auto">
									<div class="card-body">
										<ul class="d-flex mb-3">
											<li>
												<img src="images/coustomer-img/5.png" class="avatar avatar-md" alt="">
											</li>
											<li class="ms-2">
										...
										<ul class="d-flex mb-3">
											<li>
												<a href="javascript:void(0);" class="icon-bx icon-outline-bx "><svg
