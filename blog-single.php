	...
	<div id="site-wrapper">
		...
		<section id="breadcrumb" data-background="assets/img/demo/slides/02.jpg" class="parallax-window">
			<div>
				...
				<h1 class="section-title white-font text-center">Blog single</h1>
				<ul>
					<li><a href="#">Home</a></li>
					<li>Blog single</li>
				</ul>
						...
						<div class="blog-single">
							<div class="blog-item">
								<div class="entry-thumbnail">
									<a title="" href="#">
										<img src="assets/img/demo/blog/01.jpg" alt="" class="img-responsive">
									</a>
								</div>
								<div class="post-content">
									<h2 class="entry-title">
										Special food recipes for special occasions to our restaurant
									</h2>
							...
							<div class="post-comments">
								<h3 class="single-heading">Comments(04)</h3>
								<ul class="comments-tree">
									<li>
										<div class="comment">
											<a class="avatar" title="" href="#">
												<img alt="" src="assets/img/demo/comments/01.png">
											</a>
										...
										<ul class="children">
											<li>
												<div class="comment">
													<a class="avatar" title="" href="#">
														<img alt="" src="assets/img/demo/comments/02.png">
													</a>
													<div class="comment-content">
														<h4>
															John Doe
											...
											<li>
												<div class="comment">
													<a class="avatar" title="" href="#">
														<img alt="" src="assets/img/demo/comments/03.png">
													</a>
													<div class="comment-content">
														<h4>
															John Doe
									...
									<li>
										<div class="comment">
											<a class="avatar" title="" href="#">
												<img alt="" src="assets/img/demo/comments/04.png">
											</a>
											<div class="comment-content">
												<h4>
													John Doe
							...
							<div class="reply-comments">
								<h3 class="single-heading">Leave a Comment</h3>
								<form action="#" method="post" class="form-reservation">
									...
									<button type="submit" class="btn-food">Post</button>
								</form>
							</div>
						</div>
					</div>
					<div class="col-md-4 hidden-sm hidden-xs">
						<div class="sidebar">
							...
							<div class="widget widget_category">
								...
								<ul>
									<li><a href="#">Delicious<span>(29)</span></a></li>
									<li><a href="#">Wedding<span>(45)</span></a></li>
									<li><a href="#">Cooking<span>(54)</span></a></li>
									<li><a href="#">Chef<span>(36)</span></a></li>
									<li><a href="#">Indian<span>(21)</span></a></li>
								</ul>
							</div>
							<div class="widget widget_popullar">
								...
								<ul>
									<li>
										<a href="#">
											<img src="assets/img/demo/offers/02.jpg" alt="">
										</a>
										<div>
											<h4>
												<a href="#">Static image post</a>
											</h4>
											<span>6 days ago</span>
											<p>
												Neque porro quisquam est, qui em ipsum quiamet.
											</p>
										</div>
									</li>
									<li>
										<a href="#">
											<img src="assets/img/demo/offers/03.jpg" alt="">
										</a>
										<div>
											<h4>
												<a href="#">Static image post</a>
									...
									<li>
										<a href="#">
											<img src="assets/img/demo/offers/04.jpg" alt="">
										</a>
										<div>
											<h4>
												<a href="#">Static image post</a>
							...
							<div class="widget widget_tags">
								...
								<ul>
									...
									<li><a href="#">Delicious Menu</a></li>
									<li><a href="#">Food Item</a></li>
									<li><a href="#">Restaurant </a></li>
									<li><a href="#">Cafe</a></li>
									<li><a href="#">Traditional Greek</a></li>
								</ul>
							</div>
